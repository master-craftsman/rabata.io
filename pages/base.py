from playwright.sync_api import Page, TimeoutError, Response, sync_playwright
...
class Base:
    ...
    def manipulate_slider(self, slider_xpath, new_value):
        # Нажимаем PageUp new_value раз
        for _ in range(new_value):
            self.page.press(slider_xpath,'PageUp')
